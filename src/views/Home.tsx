      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl md:text-6xl">
            <span className="block">Herbario UFPS</span>
            <span className="block text-green-600 mt-2">Colección Digital</span>
          </h1>
          
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Implementación efectiva de un aplicativo web destinado a la gestión, 
            registro y consulta de las colecciones deshidratadas del herbario de 
